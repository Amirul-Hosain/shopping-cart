...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${product.image}></img>
           ...
           <h3><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i> ${product.rating.rate} Count: ${product.rating.count}</h3>
...
const updatePrice = (id, value) => {
  ...
  document.getElementById(id).innerText = (total * 1000) / 1000;
};

// set innerText function
const setInnerText = (id, value) => {
  document.getElementById(id).innerText = (value * 1000) / 1000;
};
